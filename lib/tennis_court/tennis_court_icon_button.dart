...
class tenniscourtIconButton extends StatefulWidget {
  const tenniscourtIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<tenniscourtIconButton> createState() => _tenniscourtIconButtonState();
}

class _tenniscourtIconButtonState extends State<tenniscourtIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(tenniscourtIconButton oldWidget) {
