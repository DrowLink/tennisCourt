...
Widget wrapWithModel<T extends tenniscourtModel>({
  required T model,
...
T createModel<T extends tenniscourtModel>(
...
abstract class tenniscourtModel<W extends Widget> {
...
class tenniscourtDynamicModels<T extends tenniscourtModel> {
  tenniscourtDynamicModels(this.defaultBuilder);
