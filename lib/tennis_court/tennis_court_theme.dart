...
abstract class tenniscourtTheme {
  static tenniscourtTheme of(BuildContext context) {
...
class LightModeTheme extends tenniscourtTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFF82BC00);
